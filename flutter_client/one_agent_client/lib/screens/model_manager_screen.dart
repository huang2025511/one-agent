...
class ModelManagerScreen extends ConsumerWidget {
        ...
        children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          state.currentModel?.name ?? '内置 / Canvas（未导入模型）',
          ...
          FilledButton.icon(
            onPressed: state.isImporting
                ? null
                : () => _importZip(context, ref, notifier),
                  ...
                  trailing: PopupMenuButton<String>(
                    onSelected: (v) async {
                      if (v == 'select') {
                        ...
                        await ref.read(petProvider.notifier).refreshConfig();
                      }
                      if (v == 'delete') {
          ...
          Card(
            child: ListTile(
              ...
              title: const Text('内置 / Canvas 兜底'),
              subtitle: const Text('不使用导入的模型，使用 assets 或自绘动画'),
              onTap: () async {
  ...
  Future<void> _importZip(BuildContext context, WidgetRef ref,
      Live2DModelNotifier notifier) async {
